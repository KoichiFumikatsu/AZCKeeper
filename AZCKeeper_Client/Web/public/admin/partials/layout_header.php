    ...
    <div class="min-h-full flex">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 fixed inset-y-0 left-0 z-40 flex flex-col
            ...
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto" @click.delegate="if($event.target.closest('a')) sidebarOpen = false">
                ...
                <a href="productivity.php" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-600 transition-colors <?= ($currentPage ?? '') === 'productivity' ? 'active' : '' ?>">
                ...
                <div class="pt-4 mt-4 border-t border-gray-100">
                    ...
                    <?php endif; ?>
                    <?php if (canAccessModule('install_coverage')): ?>
                    <a href="install-coverage.php" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-600 transition-colors <?= ($currentPage ?? '') === 'install_coverage' ? 'active' : '' ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                    ...
                    <?php endif; ?>
                    <?php if (canAccessModule('dual_job')): ?>
